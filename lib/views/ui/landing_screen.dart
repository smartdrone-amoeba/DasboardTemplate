...
import 'package:webui/controller/ui/landing_controller.dart';
                        ...
                        MyResponsive(builder: (_, __, type) {
                          return Padding(
                            ...
                            child: Wrap(
                              ...
                              runSpacing: 47,
                              children: [
                                buildLayoutsData([Images.squareImages[0]],
                                    "Vertical Layout"),
                                buildLayoutsData([Images.squareImages[1]],
                                    "Horizontal Layout"),
                                buildLayoutsData([Images.squareImages[2]],
                                    "Detached Layout"),
                                buildLayoutsData([Images.squareImages[3]],
                                    "Light Sidenav Layout"),
                                buildLayoutsData(
                                    [Images.squareImages[4]], "Boxed Layout"),
                                buildLayoutsData([Images.squareImages[5]],
                                    "Semi Dark Layout"),
                              ],
                            ),
                          );
