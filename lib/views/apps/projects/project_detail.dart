...
import 'package:webui/controller/apps/project/project_detail_controller.dart';
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  MyContainer.bordered(
                                      child:
                                          buildFile("WebKit-file-1", 1363148)),
                                  MySpacing.height(16),
                                  MyContainer.bordered(
                                      child:
                                          buildFile("WebKit-file-2", 10485760)),
                                  MySpacing.height(16),
                                  MyContainer.bordered(
                                      child: buildFile(
