...
import 'package:webui/controller/chat_controller.dart';
                                                    ...
                                                    child: Wrap(
                                                      ...
                                                      children: [
                                                        singleCall(
                                                            name: "You",
                                                            image:
                                                                'assets/images/dummy/avatar1.png',
                                                            cameraOn: controller
                                                                .isVideoOn,
                                                            micOn: controller
                                                                .isAudioOn),
                                                        singleCall(
                                                            name:
                                                                "Zaine Sumner",
                                                            image:
                                                                'assets/images/dummy/avatar2.png',
                                                            micOn: true),
                                                      ],
                                                    ),
                                                  ),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  MyText.bodySmall(controller.timeText,
                      color: theme.colorScheme.onBackground)
                ],
              ),
            ),
        ...
        children: [
          MyContainer.rounded(
            ...
            color: theme.colorScheme.primary
                .withAlpha(controller.isAudioOn ? 40 : 0),
            child: Icon(
              controller.isAudioOn ? LucideIcons.mic : LucideIcons.micOff,
              color: controller.isAudioOn
          ...
          MyContainer.rounded(
            ...
            clipBehavior: Clip.antiAliasWithSaveLayer,
            color: theme.colorScheme.primary
                .withAlpha(controller.isVideoOn ? 40 : 0),
            child: Center(
              child: Icon(
                  controller.isVideoOn ? LucideIcons.video : LucideIcons.videoOff,
                  color: controller.isVideoOn
                      ? theme.colorScheme.primary
                      : theme.colorScheme.onBackground.withAlpha(200)),
            ),
          ),
          ...
          MyContainer.rounded(
            ...
            child: Center(
              child: Icon(LucideIcons.phoneCall, color: contentTheme.onDanger, size: 20,),
            ),
          ),
        ],
      ),
